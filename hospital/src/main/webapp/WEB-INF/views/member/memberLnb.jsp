...
<div id="lnb" tabindex="0">
	...
	<ul class="depth1">
		...
		<ul class="depth2">
			<li id="10107" >
				<a href="${pageContext.request.contextPath}/reservation/userTreatmentForm.do">진료 예약 정보</a></li>
			<li id="10108" >
				<a href="${pageContext.request.contextPath}/reservation/userTherapyForm.do">치료 예약 정보</a></li>
		</ul>
