...
<body>
	<div class="page-main">
		...
		<div class="content-main">
			<h2 class="logreg">회원정보 수정</h2>
			<hr size="1" noshade="noshade" width="60%">
			<form id="modify_form" action="modifyUser.do" method="post">
				<ul>
					<li>
						<label for="name">이름</label>
						<input type="text" name="name" value="${member.name}" id="name" maxlength="10">
					</li>
					<li>
					...
					<li>
						...
						<input type="text" name="phone" value="${member.phone}" id="phone" maxlength="15">
					</li>
					<li>
						<label for="email">이메일</label>
						<input type="email" name="email" value="${member.email}" id="email" maxlength="50">
					</li>
					<li>
					...
					<li>
						...
						<input type="text" name="address1" value="${member.address1}" id="address1" maxlength="30">
					</li>
					<li>
						<label for="address2">나머지 주소</label>
						<input type="text" name="address2" value="${member.address2}" id="address2" maxlength="30">
					</li>
				</ul>
