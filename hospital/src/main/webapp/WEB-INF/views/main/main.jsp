		...
		<div class="main-div">
			<div class="main-div-content">
				<ul>
					...
					<li class="main-content">비수술적 치료를 우선으로 하지만 그 자신감은 풍부한 수술 경험에
						있습니다. 본원 의료진들은 다년간의 수술에 참여하였으며, 그만큼 폭넓은 지식이 있기 때문에 꼭 필요한 경우가 아니라면
						비수술적 치료에 초점을 둡니다.</li>
				</ul>
			</div>
		...
		<div class="main-div">
			...
			<div class="main-div-content">
				<ul>
					...
					<li class="main-content">환자가 최대한 이해할 수 있도록 환자의 상태를 어렵거나 복잡하지
						않게 설명합니다. 또한, 수술로 치료했을 경우와 비수술로 치료했을 경우의 차이점, 수술 난이도나 위험성도 환자에게
						상세하게 제시합니다.</li>
				</ul>
			</div>
		</div>
