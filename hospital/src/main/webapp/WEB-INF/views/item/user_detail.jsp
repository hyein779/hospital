	...
	<div class="page-main">
		...
		<div class="order-notice">
			<table class="express">
				...
				<tr>
					<td>■ 배송비 : 전 상품 무료배송입니다(산간벽지나 도서지방은 추가 요금이 발생할 수 있음).</td>
				</tr>
				<tr>
					<td>■ 오후 2시 이전의 주문(입금확인)은 당일발송, 다음날 수령하실 수 있습니다.</td>
				</tr>
			</table>
			<table class="refund">
				<tr>
					<td colspan="2" class="notice-title">&nbsp;교환 및 반품 안내</td>
				</tr>
				<tr>
					<td>■ 상품 교환 및 반품 가능 기간은 상품 수령일로부터 7일 이내 입니다.</td>
				</tr>
				<tr>
					<td>■ 상품 개봉 또는 사용으로 훼손된 경우 7일 이내라도 교환 및 반품이 불가능합니다.</td>
				</tr>
				<tr>
					<td>■ 고객 변심으로 인한 교환, 반품은 고객께서 배송비를 부담하셔야 합니다. (제품 하자, 배송 오류 제외)</td>
				</tr>
				<tr>
					<td>■ 일부 상품은 새로운 모델 출시, 제조사 사정으로 가격이 변동될 수 있습니다.</td>
				</tr>
				<tr>
